...
return [
    ...
    'profile' => [
        ...
        'browser_sessions' => [
            'heading' => 'الجلسات النشطة',
            'subheading' => 'إدارة الجلسات النشطة.',
            'label' => 'الجلسات النشطة',
            'content' => 'إذا لزم الأمر، يمكنك تسجيل الخروج من جميع جلسات المتصفح الأخرى عبر جميع أجهزتك. بعض جلساتك الأخيرة مدرجة أدناه؛ ولكن قد لا يكون هذا القائمة مكتملاً. إذا كنت تشعر أن حسابك قد تم تهديده، يجب عليك أيضًا تحديث كلمة المرور الخاصة بك.',
            'device' => 'هذا الجهاز',
            'last_active' => 'الأخير على',
            'logout_other_sessions' => 'تسجيل الخروج من جميع الجلسات الأخرى',
            'logout_heading' => 'تسجيل الخروج من جميع الجلسات الأخرى',
            'logout_description' => 'الرجاء إدخال كلمة المرور لتأكيد أنك تريد تسجيل الخروج من جميع الجلسات الأخرى عبر جميع الأجهزة.',
            'logout_action' => 'تسجيل الخروج من جميع الجلسات الأخرى',
            'incorrect_password' => 'كلمة المرور التي أدخلتها غير صحيحة. الرجاء المحاولة مرة أخرى.',
            'logout_success' => 'تم تسجيل الخروج من جميع الجلسات الأخرى بنجاح.',
        ],
    ],
    'clipboard' => [
